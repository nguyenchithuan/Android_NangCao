...
public class ChiTiet {
    ...
    public ChiTiet(int maSp_ph26023, int maHd_ph26023, int slXuat_ph26023, int dgXuat_ph26023) {
    ...
    public ChiTiet(int maCTHD_ph26023, int maSp_ph26023, int maHd_ph26023, int slXuat_ph26023, int dgXuat_ph26023) {
